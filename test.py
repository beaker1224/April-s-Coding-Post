...
if addiction == "vaping":
    print("Ok, I see. ")
    Q2 = input("Would you like to know the pros and cons of vaping, or would you like help to break your vaping habit? (a = pros and cons, b = smoking/drinking habit.) ")
